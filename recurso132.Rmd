---
title: <span style="color:#034a94">**Estimación dos poblaciones**</span>
subtitle: "Unidad "
author: "dgonzalez80"
date: ""
output:
...
## **Intervalos de confianza para comparación de dos poblaciones**
...
|    |                                     |
|:--:|:------------------------------------|
| ![](img/ej1.png){width=120%} | Se afirma que una persona podrá reducir su peso en un periodo de dos semanas un promedio de 4.5 kilogramos con una nueva dieta. Los pesos de 7 mujeres de siguieron  esta dieta se registraron antes y después de un periodo de dos semanas.  |
...
Supone varianzas iguales y desconocidas
...
|    |                                     |
|:--:|:------------------------------------|
| ![](img/ej2.png){width=120%} | A seis ingenieros que trabajan para el estado se les solicito realizar un pronostico la tasa de inflación para el año entrante. La misma petición se le realizo a ocho especialistas en finanzas que trabajan para el sector privado. Los pronósticos entregado fueron: |
...
Supone varianzas diferentes, pero desconocidas 
...
|    |                                     |
|:--:|:------------------------------------|
| ![](img/ej3.png){width=120%} | Supongamos el mismo caso del ejemplo anterior, pero con los siguientes datos :   
