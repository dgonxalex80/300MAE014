...
### **Cálculo de la Suma de Cuadrados Dentro de los grupos** ($SC_D$)
...
En caso de rechazar la hipótesis nula (Ho) se requiere realizar la prueba de comparaciones múltiples para determinar los grupos que conforman
