...
IDENTIFICAR, CALCULAR, CONTRASTAR y CONCLUIR sobre una hipótesis estadística sobre parámetros de una población, que le permita la elección de la prueba más potente para la verificación de una prueba de hipótesis, permitiéndole tomar decisiones informadas.

<br/><br/>

## **Duración**

La presente  unidad será desarrollada durante la comprendida entre 4 y 10 de marzo de 2024. Ademas del material suministrado  contaran con el acompañamiento del profesor y de un monitor. Los entegables para esta unidad podrán enviarse a través de la plataforma Brightspace hasta el  10 de marzo.
...
|:-----------------|:-----------------------------  |
|**Actividad 431** | Resuelva las preguntas y problemas planteadas en el **Taller 311** y entregue su solución  en formato  pdf en el enlace correspondiente de  Brightspace   |
|Trabajo en pareja |                                |
|Fecha             | marzo 10 de 2024            |
